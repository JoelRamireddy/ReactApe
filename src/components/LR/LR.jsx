...
// export default function TopSearchSelect(props) {
//   let cat = props.catalog;

//   let objarr = [];
//   let obj;
//   //let r = [...c["tmp"]["som"]];
//   // console.log(c["tmp"]["som"]);
//   for (let key in cat) {
//     if (key == 'courses'){
//       for(let ke in cat[key]){
//        obj = {id:null, name:null, description:null, credits:null};
//          for(let k in cat[key][ke]){
//            let r = cat[key][ke][k];
...
//     // for (let y in tmp[h]) {
//     //   console.log(tmp[h][y]);
//     //   for (let u in tmp[h][y]) {
//     //     console.log(tmp[h][y][u]);
//     //   }
//     // }
//   //}

//   // let tmp = props.catalog.courses.map((course) => {
//   //   return {
//   //     id: course.id,
//   //     title: course.title,
              ...
              <table id="data-table" class="display" width="99%">
                <thead>
                  <tr>
                    ...
                    <th id="bottom-right-header">Description</th>
                  </tr>
                </thead>
                <tbody>
                  {arr.map((course) => (
